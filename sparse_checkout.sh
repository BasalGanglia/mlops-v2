...
git_folder_location='C:\Users\ilkka\code\macopsv2'   #replace with the local root folder location where you want to create the project folder
project_name=macv2-sparse  #replace with your project name
github_org_name=BasalGanglia  #replace with your github org name
project_template_github_url=https://github.com/BasalGanglia/mlops-v2-template #replace with the url for the project template for your organization created in step 2.2, or leave for demo purpose
